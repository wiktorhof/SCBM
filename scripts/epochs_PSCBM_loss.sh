...
#Obtained by tuning.
# This script is for comparing PSCBMs trained for different numbers of epochs.
...
for p_epochs in 10 20 50 100 400
do
...
do
        ...
        model.p_epochs=${p_epochs} model.i_epochs=200 model.lr_scheduler=${lr_scheduler} \
        ...
        'model.additional_tags=[SCBM_loss,epochs]' \
